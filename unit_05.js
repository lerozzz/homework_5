...
function t5() {
    for (let i = 1; i <= 17; i++) {
        ...
        else { document.querySelector('.out-5').innerHTML += i + '_*'; }
...
function t11() {
    ...
    for (let i = 0; i <= a.length - 1; i++) {
        ...
        document.querySelector('.out-11').innerHTML += a[i].textContent + ' ';
    }
}
...
function t12() {
    ...
    let outElem = document.querySelector('.out-12');
    for (let i = 0; i < a.length; i++) {
        outElem.innerHTML += a[i].textContent + ' ';
    }
    outElem.style.background = 'orange';
}
